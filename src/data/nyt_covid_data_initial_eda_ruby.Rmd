...
nyt_covid_new <- nyt_covid %>%
  ...
  mutate(
    ...
    ,new_deaths = deaths - lag(deaths, default = first(cases), order_by = date)
  )
...
nyt_covid_negative # negative values are assumed to be corrective adjustments on previous day erroneous data entry
```
